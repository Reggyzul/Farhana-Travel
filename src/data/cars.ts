...
export const CARS: Car[] = [
  {
    ...
    category: 'Family MPV',
    pricePerDay: 200000,
    priceDisplay: 'Mulai Rp 200.000 / Hari',
    image: '/ertiga.png',
    seats: 7,
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    text: 'Tarifnya terjangkau banget mulai 200 ribu. Proses booking via WhatsApp cepat dan ramah. Rekomendasi banget untuk warga Tuban dan sekitarnya!',
    rating: 5,
