...
export const CARS: Car[] = [
  {
    ...
    category: 'Family MPV',
    pricePerDay: 150000,
    priceDisplay: 'Mulai 150 Ribu-an',
    image: '/ertiga.png',
    seats: 7,
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    text: 'Pelayanannya sangat ramah dan memuaskan. Proses booking via WhatsApp cepat dan praktis. Rekomendasi banget untuk warga Tuban dan sekitarnya!',
    rating: 5,
