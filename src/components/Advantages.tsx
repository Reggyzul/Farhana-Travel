...
export default function Advantages({ onBookClick }: AdvantagesProps) {
  const advantagesList = [
    ...
    },
    {
      ...
      description: 'Tarif sewa & travel mulai 150 ribu-an. Sangat transparan tanpa biaya tersembunyi, cocok untuk kantong keluarga maupun bisnis.',
      highlights: ['Mulai 150 Ribu-an', 'Tanpa Biaya Siluman', 'DP Ringan / Bayar di Tempat']
    },
    {
      id: 'door-to-door',
  ...
  const statItems = [
    ...
    { label: 'Tarif Sewa', value: '150 Ribu-an', subText: 'Mulai Sewa & Travel' },
            ...
            <div className="lg:col-span-7 space-y-4 text-left">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                ...
                {onBookClick && (
                  ...
                  >
                    Lihat Armada (Mulai 150 Ribu-an)
                  </button>
                )}
              </div>
            </div>
