...
export default function Advantages({ onBookClick }: AdvantagesProps) {
  const advantagesList = [
    ...
    },
    {
      ...
      description: 'Tarif sewa & travel mulai dari Rp 300.000 / Hari. Sangat transparan tanpa biaya tersembunyi, cocok untuk kantong keluarga maupun bisnis.',
      highlights: ['Mulai Rp 300rb/Hari', 'Tanpa Biaya Siluman', 'DP Ringan / Bayar di Tempat']
    },
    {
      id: 'door-to-door',
  ...
  const statItems = [
    ...
    { label: 'Tarif Sewa', value: '300 Rb', subText: 'Mulai per Hari' },
